...
The beginnings were modest. Then open-source projects started arriving. Ruby on Rails joined the platform, followed by many other frameworks. Word of mouth did the rest.
...
In June 2018, [Microsoft](https://www.microsoft.com) announced the acquisition of GitHub for $7.5 billion. The community’s reaction was immediate and fierce. Thousands of developers announced they were moving to [GitLab](https://about.gitlab.com/) or [Bitbucket](https://www.atlassian.com/software/bitbucket). Some called it a betrayal; others saw it as the end of an era.

The fear was understandable. Microsoft had historically had a strained relationship with open source. Its CEO, [Steve Ballmer](https://www.linkedin.com/in/steve-ballmer-7087a8157), had once called [Linux](https://www.linux.org/) a “cancer.” Entrusting the world’s open-source platform to this giant seemed paradoxical.
...
[Richard Stallman](https://stallman.org/), founder of the free software movement in the 1980s, framed the question in moral terms: is it ethical to keep secret the inner workings of a tool used by millions of people? For him, the answer was no. Code should be free just as speech is free.

The open-source movement of the 1990s, led notably by Eric Raymond, took a more pragmatic approach: open code produces better software because more people can examine, improve, and adapt it.
...
A question often comes up: ***why do companies like Google, Microsoft, Facebook, and Red Hat invest heavily in open-source projects? What’s in it for them?***
...
In 2021, a critical security flaw was discovered in Log4j, a Java library used in thousands of enterprise applications. It was maintained by a few volunteers in their spare time. The entire industry suddenly realized just how much it relied on the unpaid work of strangers.
...
---
## Chapter 3: GitHub Projects

**GitHub Projects** is a project management tool that is directly integrated into the platform. 
It allows you to create Kanban boards, list views, and calendar views, and to link tasks directly to issues and pull requests. 

The main advantage: there’s no disconnect between planning and execution. 
A task on the project board is directly linked to the technical discussion in the corresponding issue, the code in the pull request, and the completed deployment. 

For product or design teams, working in GitHub Projects alongside developers creates continuity that eliminates many organizational friction points.
...
I know, this isn’t exactly news. And there are other options out there.

For example, Render offers an attractive free plan, but applications can go into sleep mode after a period of inactivity. As a result, the first visitor may sometimes have to wait several dozen seconds before the site restarts.

There’s also Vercel, which is more advanced and particularly popular for modern applications. But today, let’s keep it simple.

With GitHub Pages, a repository becomes a website.
